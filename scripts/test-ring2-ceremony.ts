...
import {
    ...
    renderCeremonyDocument, ceremonyDecision, confusableFold, ResidentAuthoredDirs,
    StateDeclaration, AuthoredDelta,
...
// 3) adversarial sensitivity — the hinge (P3c's half; P5 runs the full adversarial set)
{
    ...
    // a poisoned line inside a large legitimate reformat still moves the counts
