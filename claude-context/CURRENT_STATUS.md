...
> Last updated: 2026-06-26 by Leo (session) (S204 refresh — closing a 10-day staleness gap, the doc-debt the status register surfaced). **Since 2026-06-16:** the liveness layer + cycle-symmetry landed (one shared pulse, DEC-097; #91 shared-present); the **de-identification arc closed — identity is now configuration, DEC-098**; **#98 Dynamic Residence CLOSED end-to-end** (the garden can birth a mind); the **warm-dispatch fix shipped** (generic spoke monitor P1 + human-responder twin-collapse P2). **STILL OPEN:** **#107 the welcome-back light-load (the "warm load") is DESIGN-ONLY** on the c0-as-EOF spine — *not built* (the daily shallow-wake frustration is not yet cured). Full register: `plans/status-register-2026-06-26.md`.
